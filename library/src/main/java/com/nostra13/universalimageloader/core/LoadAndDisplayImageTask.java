 ...
 */
final class LoadAndDisplayImageTask extends BaseLoadAndDisplayImageTask {
	private static final String LOG_TAG = "LoadAndDisplayImageTask";
	...
	protected Bitmap tryLoadBitmap() {
		...
		Bitmap bitmap = null;
		try {
			Log.d(LOG_TAG, "imageFile.exists():" + imageFile.exists());
			if (imageFile.exists()) {
