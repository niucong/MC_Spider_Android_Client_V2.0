...
public interface ImageDownloader {
	...
	InputStream getStream(String imageUri, Object extra,ImageLoadingListener listener) throws IOException;

	/** Represents supported schemes(protocols) of URI. Provides convenient methods for work with schemes and URIs. */
	public enum Scheme {
		HTTP("http"), HTTPS("https"), FILE("file"), CONTENT("content"), ASSETS("assets"), DRAWABLE("drawable"), LOCAL("local"),UNKNOWN("");
