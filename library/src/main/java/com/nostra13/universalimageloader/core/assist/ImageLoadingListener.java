...
public interface ImageLoadingListener {
	...
	/**
     * Is called when image loading 
     * @param progress the progress of the loading
 
     */
	void onLoadingProgress(int progress, int load, int len);
	...
	/**
	 * is called before downloading
	 * @param ProgressMax the image file size;
	 */
