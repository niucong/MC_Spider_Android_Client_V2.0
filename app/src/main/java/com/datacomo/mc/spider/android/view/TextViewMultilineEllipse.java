...
//    
//    String delta = "#$#";
//	int lth = delta.length();
//	int lth_colon = ":".length();
...
//    }
//    
//	public void setTextInLinearLayout(CharSequence text, LinearLayout parent, int index, LayoutParams params) {
//        mText = (String) text;
//        requestLayout();
//        invalidate();
...
//                    }else{/**chinese*/
//                        lengthThisLine += (widthOfChar + 2.0f);
//                    }
//                    
