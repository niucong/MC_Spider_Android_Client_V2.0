 ...
 * 
 */
public class SearchMyContactLeaguersParams extends BasicParams {
	 ...
	 * @param noPaging
	 */
	public SearchMyContactLeaguersParams(Context context, String content,
	...
	private void setVariable(String content, String startRecord,
		...
		paramsMap.put("method", "searchMyContactLeaguers");
