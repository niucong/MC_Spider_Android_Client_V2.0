 ...
 * 
 */
public class EditCloudNoteParams extends BasicParams {
	 ...
	 *            第一张图片地址
	 */
	public EditCloudNoteParams(Context context, String noteId,
			String oweToNoteBook, String noteBookId, String title,
			String content, String sourceType, String[] attachments,
			String statTarget, String updateAddress, String firstPhotoPath) {
		super(context);
		setVariable(noteId, oweToNoteBook, noteBookId, title, content,
				sourceType, attachments, statTarget, updateAddress,
				firstPhotoPath);
	}
	 ...
	 * 设置参数
	 */
	private void setVariable(String noteId, String oweToNoteBook,
		...
		paramsMap.put("method", "editCloudNote");
