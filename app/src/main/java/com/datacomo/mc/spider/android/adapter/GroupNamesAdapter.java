...
public class GroupNamesAdapter<T> extends BaseAdapter implements Filterable {
	 ...
	 */
	public GroupNamesAdapter(Context context, int textViewResourceId) {
	 ...
	 *            populated
	 */
	public GroupNamesAdapter(Context context, int resource,
	...
	private View createViewFromResource(int position, View convertView,
		...
		text.setText(groupEntity.getName());
	...
	private class ArrayFilter extends Filter {
		...
		protected FilterResults performFiltering(CharSequence prefix) {
			...
			if (prefix == null || prefix.length() == 0) {
				...
				final ArrayList<GroupEntity> newValues = new ArrayList<GroupEntity>(
						count);

				for (int i = 0; i < count; i++) {
					final GroupEntity value = (GroupEntity) values.get(i);
					final String displayName = value.getName().toLowerCase();
					final String pyName = value.getGroupNamePy().toLowerCase();
					final String jpName = value.getGroupNameJp().toLowerCase();
