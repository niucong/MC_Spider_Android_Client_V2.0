...
public class CloudFileLeaguerAdapter extends BaseAdapter {
	private Context c;
	private ArrayList<FileShareLeaguerBean> mbers;

	public CloudFileLeaguerAdapter(Context context,
			ArrayList<FileShareLeaguerBean> data, ListView listView) {
		c = context;
		mbers = data;
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final FileShareLeaguerBean bean = mbers.get(position);
