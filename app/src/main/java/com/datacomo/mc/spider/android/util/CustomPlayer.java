...
public class CustomPlayer {
    ...
    private static OnCustomCompletionListener mCustomCompletionListener;
        ...
        try {
            ...
            player.setOnCompletionListener(new OnCompletionListener() {
    			...
    			public void onCompletion(MediaPlayer mp) {
    				...
    				mCustomCompletionListener.onCompletion();
    			}
    		});
            player.prepare();
            player.start();
    ...
    public static void setOnCustomCompletionListener(OnCustomCompletionListener onCustomCompletionListener){
    	mCustomCompletionListener=onCustomCompletionListener;
    }
